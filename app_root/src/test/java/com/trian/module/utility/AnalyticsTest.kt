...
import com.trian.common.utils.analytics.analyzBmi
import com.trian.domain.utils.analytics.analyzeHeartRate
import com.trian.domain.utils.analytics.analyzeRespiratory
import com.trian.domain.utils.analytics.analyzeSpo2
import com.trian.domain.utils.analytics.analyzeTemperature
...
class AnalyticsTest {
    ...
    fun `should success analyze bpm`(){
        ...
        val resultOptimal = com.trian.domain.utils.analytics.analyzeBPM(119, 60)
        val resultNormal = com.trian.domain.utils.analytics.analyzeBPM(124, 82)
        val resultNormalHigh = com.trian.domain.utils.analytics.analyzeBPM(131, 86)
        val resultHypertensionGrade1 = com.trian.domain.utils.analytics.analyzeBPM(144, 99)
        val resultHypertensionGrade2 = com.trian.domain.utils.analytics.analyzeBPM(165, 105)
        val resultHypertensionGrade3 = com.trian.domain.utils.analytics.analyzeBPM(180, 110)
